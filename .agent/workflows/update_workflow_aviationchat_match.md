...
> **The source of truth is:** `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\`
...
1. List all files in `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\rules\`
...
1. List all files in `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\workflows\`
...
1. List all directories in `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\skills\`
...
1. Read the source file from `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\rules\`
...
1. Read the source file from `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\workflows\`
...
1. Copy the entire skill directory from `c:\Sudo_Hatter_Command\Projects\aviationChat-AGY\.agent\skills\[skill-name]\` to `c:\Sudo_Hatter_Command\Projects\clean-bmad-workspace\.agent\skills\[skill-name]\`
