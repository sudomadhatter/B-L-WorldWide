      ...
      <ScrollReveal className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 divide-y md:divide-y-0 md:divide-x divide-white/10">
          <div className="pt-8 md:pt-0 md:pl-0 flex justify-center md:justify-start">
            <StatItem endValue={1500} suffix="+" label="Projects Completed" />
          </div>
          <div className="pt-8 md:pt-0 md:pl-12 flex justify-center md:justify-start">
            <StatItem endValue={85} suffix="+" label="Countries Reached" />
          </div>
          <div className="pt-8 md:pt-0 md:pl-12 flex justify-center md:justify-start">
            <StatItem endValue={45} suffix="B" label="Capital Deployed (USD)" />
          </div>
        </div>
      </ScrollReveal>
    </section>
